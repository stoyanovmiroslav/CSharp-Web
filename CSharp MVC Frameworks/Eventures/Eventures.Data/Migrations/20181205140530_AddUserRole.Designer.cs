...
namespace Eventures.Data.Migrations
{
    ...
    [Migration("20181205140530_AddUserRole")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Eventures.Models.EventuresRole", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Eventures.Models.EventuresUserRole", b =>
                {
            ...
            modelBuilder.Entity("Eventures.Models.EventuresUserRole", b =>
                {
                    b.HasOne("Eventures.Models.EventuresRole", "Role")
                        .WithMany("UserRoles")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("Eventures.Models.EventuresRole")
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
