...
namespace Eventures.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            [Required]
            [Display(Name = "UCN")]
            [RegularExpression(@"^\d{10}$", ErrorMessage = "The {0} Should consist of exactly 10 numbers.")]
            ...
            [Required]
            [RegularExpression(@"^[a-zA-Z.\-*_~]+$", ErrorMessage = "The {0} can contains special simbols like: \".-_*~\".")]
